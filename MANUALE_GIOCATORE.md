...
**Il denaro FIAT sta attaccando!** Le valute centralizzate - Dollaro, Euro, Yen e le loro alleate - hanno dichiarato guerra alla libertà finanziaria. Il tuo compito: pilotare la tua nave crypto e difendere il futuro decentralizzato.

Distruggi le ondate di valute fiat, affronta i boss delle Banche Centrali (FED, BCE, BOJ) e accumula punti. Ogni nemico abbattuto è un passo verso **l'Hyperbitcoinization**!

---

## 2. Comandi (Quick Start)
...
## 5. I Nemici (Valute FIAT)

### Tier Debole (Facili)
| Simbolo | Valuta | Aspetto |
|---------|--------|---------|
| **¥** | Yen | Moneta |
| **₽** | Rublo | Banconota |
| **₹** | Rupia | Moneta |
...
| **£** | Sterlina | Moneta |
| **₣** | Franco | Lingotto |
| **₺** | Lira Turca | Banconota |

### Tier Forte (Pericolosi!)
| Simbolo | Valuta | Aspetto |
|---------|--------|---------|
| **$** | Dollaro | Banconota |
| **元** | Yuan | Lingotto |
| **Ⓒ** | CBDC | Carta di credito |
...
| Boss | Simbolo | Stile |
|------|---------|-------|
| **THE FED** | $ | Aggressivo, attacchi rapidi |
| **BCE** | € | Burocratico, muri di proiettili |
| **BOJ** | ¥ | Zen, precisione letale |
...
- **85%+**: Fase PANICO, nemici sparano il 40% più veloce!
