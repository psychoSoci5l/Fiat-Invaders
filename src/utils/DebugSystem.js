...
window.Game.Debug = {
    ...
    audioState() {
        ...
        const state = {
            ...
            effectsActive: audio._godchainEffectsActive,
            hyperFlag: audio._hyperActiveFlag,
            masterFilter: !!audio._godchainMasterFilter,
            bassDistortion: !!audio._godchainBassDistortion,
            padReverbExtra: !!audio._godchainPadReverbExtra,
            arpReverbExtra: !!audio._godchainArpReverbExtra,
