...
**FIAT money is attacking!** Centralized currencies - Dollar, Euro, Yen and their allies - have declared war on financial freedom. Your mission: pilot your crypto ship and defend the decentralized future.

Destroy waves of fiat currencies, face the Central Bank bosses (FED, ECB, BOJ) and stack points. Every enemy destroyed is a step toward **Hyperbitcoinization**!

---

## 2. Controls (Quick Start)
...
## 5. Enemies (FIAT Currencies)

### Weak Tier (Easy)
| Symbol | Currency | Shape |
|--------|----------|-------|
| **¥** | Yen | Coin |
| **₽** | Ruble | Bill |
| **₹** | Rupee | Coin |
...
| Boss | Symbol | Style |
|------|--------|-------|
| **THE FED** | $ | Aggressive, rapid attacks |
| **ECB** | € | Bureaucratic, bullet walls |
| **BOJ** | ¥ | Zen, lethal precision |
...
- **85%+**: PANIC phase, enemies fire 40% faster!
